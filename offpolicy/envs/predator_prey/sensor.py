...
class SensorEnv(MultiAgentEnv):
    ...
    def __init__(self,kwargs):
        ...
        self.array_width = self.args.array_width
        self.array_height = self.args.array_height
        self.n_agents = self.array_height * self.array_width
        self.num_agents = self.array_height * self.array_width
        self.n_preys = self.args.n_preys
        self.episode_limit = self.args.episode_length
        self.map_height = 2 * self.array_height - 1
        self.map_width = 2 * self.array_width - 1
        self.catch_reward = self.args.catch_reward
        self.scan_cost = self.args.scan_cost
    ...
    def step(self, actions):
        ...
        #actions = np.where(actions==1)[1][:,None]
    ...
    def get_state_size(self):
        ...
        return [self.n_agents * self.obs_size]
