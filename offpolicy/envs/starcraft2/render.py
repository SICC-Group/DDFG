...
class StarCraft2Renderer:
    ...
    def render(self, mode):
        ...
        pygame.image.save(self.display,f"smactest/smac_{self.step}.png")
        #import pdb;pdb.set_trace()
        # plt.imshow(np.transpose(observation, axes=(1, 0, 2)))
        # plt.savefig(f"smac_{self.step}.png")
        # plt.close()
        return (
