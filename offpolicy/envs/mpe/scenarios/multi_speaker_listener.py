...
class Scenario(BaseScenario):
    def make_world(self, args):
        ...
        world.dim_c = 5
        num_listeners = args.num_agents // 2
        num_speakers = args.num_agents // 2
    ...
    def reward(self, agent, world):
        ...
        share_rews = False
        if share_rews:
            return sum(self.pair_rewards), 0, 0
        if agent.listener:
            return self.pair_rewards[agent.speak_ind], 0, 0
        else:
            return self.pair_rewards[agent.goal_a.speak_ind], 0, 0
