...
class DMAQ_QattenMixer(nn.Module):
    def __init__(self, args, num_agents, cent_obs_dim, act_dim, unit_dim, device):
        ...
        self.attention_weight = Qatten_Weight(args, num_agents, cent_obs_dim, act_dim,unit_dim)
        self.si_weight = DMAQ_SI_Weight(args, num_agents, cent_obs_dim, act_dim)
        self.to(device)
