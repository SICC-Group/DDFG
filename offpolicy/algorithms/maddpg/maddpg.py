...
class MADDPG(Trainer):
    ...
    def get_update_info(self, update_policy_id, obs_batch, act_batch, nobs_batch, navail_act_batch):
        ...
        for p_id in self.policy_ids:
            ...
            #print(act_batch[p_id].shape)
            combined_nobs_batch = np.concatenate(nobs_batch[p_id], axis=0)
            #print(combined_nobs_batch.shape)
            #sys.exit()
            ...
            #print(cent_nact[0].shape)
            #print(num_pol_agents)
            #sys.exit()
            ind += num_pol_agents
    ...
    def shared_train_policy_on_batch(self, update_policy_id, batch):
        ...
        #print(obs_batch["policy_0"].shape)
        ##print(cent_obs_batch["policy_0"].shape)
        #rint(act_batch["policy_0"].shape)
        #print(valid_transition_batch["policy_0"].shape)
        #print(rew_batch["policy_0"].shape)
        #print(dones_env_batch["policy_0"].shape)
        #print(navail_act_batch)
        #sys.exit()
        #import pdb;pdb.set_trace()
        train_info = {}
        ...
        #print(rew_batch[update_policy_id][:,0])
        #sys.exit()
        ...
        #print(np.concatenate(cent_act, axis=-1).shape)
        #print(update_actor)
